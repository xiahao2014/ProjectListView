...
/**
 * The SwipeRefreshLayout2 should be used whenever the user can refresh the
 * contents of a view via a vertical swipe gesture. The activity that
 * instantiates this view should add an OnRefreshListener to be notified
 * whenever the swipe to refresh gesture is completed. The SwipeRefreshLayout2
 ...
 * width and the height supplied in this layout. The SwipeRefreshLayout2 does not
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    /**
     * Simple constructor to use when creating a SwipeRefreshLayout2 from code.
     *
     * @param context
     */
    ...
    /**
     * Constructor that is called when inflating SwipeRefreshLayout2 from XML.
     *
     * @param context
     * @param attrs
     */
    ...
    public interface OnChildScrollUpCallback {
         ...
         *
         * @param parent SwipeRefreshLayout2 that this callback is overriding.
         * @param child The child view of SwipeRefreshLayout2.
         *
